    ...
    <div className="max-w-[1400px] mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-8 border border-white/10 bg-[#0E0E0E]" data-testid="cart-items">
          {items.map((i) => (
            <div key={i.product_id} className="grid grid-cols-[80px,1fr,auto] sm:grid-cols-[100px,1fr,auto,auto] gap-4 items-center p-4 border-b border-white/5 last:border-0">
              ...
              <button onClick={() => removeItem(i.product_id)} data-testid={`cart-remove-${i.sku}`} className="p-2 text-zinc-500 hover:text-amber-400">
