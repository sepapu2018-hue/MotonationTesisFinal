  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 p-4" data-testid="confirm-dialog">
      <div
        ...
        tabIndex={-1}
        className="w-full max-w-sm bg-[#141414] border border-white/10 p-7 outline-none"
      >
        <div className="flex items-start justify-between mb-4">
          ...
          <button type="button" onClick={onCancel} aria-label="Cerrar" className="text-zinc-500 hover:text-white"><X className="h-4 w-4" /></button>
        </div>
        <h3 id="confirm-dialog-title" className="font-display font-black text-xl uppercase">{title}</h3>
